...
**Homepage:** <https://github.com/bitnomee/thanos>
...
|------------|------|---------|
| oci://ghcr.io/bitnomee/charts | common | ~2.31.5 |
...
| volumePermissions.image.repository | string | `"library/busybox"` |  |
| volumePermissions.image.tag | string | `"1.38.0"` |  |
